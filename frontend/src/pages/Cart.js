                        ...
                        data.map((product, index) => (
                            <div key={product?._id} className='w-full bg-white h-32 my-2 border border-slate-300 rounded grid grid-cols-[128px,1fr]'>
                                ...
                                <div className='px-4 py-2'>
                                    ...
                                    <div className='flex items-center gap-3 mt-1'>
                                        <button
                                            className='border border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-white w-6 h-6 flex justify-center items-center rounded'
                                            onClick={() => decreaseQty(product?.productId?._id, product?.quantity)}
                                        >-</button>
                                        <span>{product?.quantity}</span>
                                        <button
